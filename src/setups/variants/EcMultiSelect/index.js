export default {
  ...
  primary: {
    el: {
      root: "flex items-center rounded-lg bg-cWhite border border-c0-300 w-full",
      tagRoot: "flex flex-wrap w-full",
      tag: "px-2 py-1 m-1 rounded bg-c2-400 text-cWhite",
      tagSingle: "px-2 py-1 m-1 rounded bg-c2-400 text-cWhite w-full flex justify-between",
      tagRemove: "ml-2",
      ...
      selectedOption: "bg-c2-400 text-cWhite select-none px-5 py-2",
      noOption: "px-5 py-2",
      transition: {
        enterFrom: "opacity-0",
        leaveTo: "opacity-0",
