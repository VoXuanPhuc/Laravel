export default {
  ...
  "primary-disabled": {
    ...
    el: {
      root: "text-base bg-c0-50 text-cBlack rounded-md leading-tight border border-c0-300 px-5 appearance-none w-full h-8 placeholder-c0-500 focus:outline-none focus:border-c1-500 cursor-not-allowed",
    },
  },
}
