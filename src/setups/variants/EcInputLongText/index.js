export default {
  ...
  primary: {
    el: {
      root: "bg-cWhite title-2 text-c0-500 rounded-md border border-c0-300 px-5 py-3 appearance-none w-full min-h-10 placeholder-c0-500 focus:outline-none focus:outline-none focus:border-c1-500",
    },
  },
  transparent: {
    el: {
