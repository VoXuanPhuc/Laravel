export default {
  ...
  "primary-lg": {
    el: {
      circle: "inline-block w-12 h-12 border-t-2 rounded-full border-cWhite",
      dots: "flex justify-center items-center w-auto h-auto",
      dotsItem: "w-12 h-12 rounded-full inline-block bg-c1-500",
    },
  },
  secondary: {
    el: {
  ...
  "secondary-lg": {
    el: {
      circle: "inline-block w-12 h-12 border-t-4 rounded-full border-c1-500",
      dots: "flex justify-center items-center w-auto h-auto",
      dotsItem: "w-4 h-4 rounded-full inline-block bg-c1-500",
    },
  },
