...
use Encoda\Activity\Repositories\Concrete\TolerablePeriodDisruptionRepository;
...
class RepositoriesBindingProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app->bind( TolerablePeriodDisruptionRepositoryInterface::class, TolerablePeriodDisruptionRepository::class );
    }
}
